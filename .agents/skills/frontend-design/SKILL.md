...
- **Spatial Composition**: Unexpected layouts. Asymmetry. Overlap. Diagonal flow. Grid-breaking elements. Generous negative space OR controlled density. Use hairline rules (`border-t`) or generous whitespace to separate content zones — clear visual rhythm between sections is more important than decorative dividers.
